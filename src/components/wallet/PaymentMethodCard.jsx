...
<<<<<<< HEAD
            {hasImage ? (
              <img
                src={method.image}
                alt={method.name}
                className="h-11 w-11 shrink-0 rounded-xl border border-gray-200 object-cover transition-transform group-hover:scale-110 sm:h-12 sm:w-12 dark:border-gray-700"
              />
            ) : (
